...
; ===============================
; Monster Mansion GBC main source
; ===============================
...
endc
ROMTitle:       dbp "GBCOMPO23",15,0            ; ROM title (15 bytes)
...
.wait
    ...
    farcall DSX_Init   ; prevent glitch music from playing
...
include "Engine/GameModes/SpriteViewer.asm"
...
.continue                           ; done
    ...
    farcall DSX_Update
:   call    DSFX_Update           ; *do* update SFX while game is paused (for pause sound)
...
include "Engine/Metasprite.asm" ; Metasprite routines
